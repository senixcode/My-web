...
const myWebsite = (currentLanguagee: string): IProject => ({
  ...
  titleSeo: translater(currentLanguagee, {
    es: "senixcode_mi_web",
    en: "senixcode_my_website",
  }),
  summary: translater(currentLanguagee, {
    es:
      "Un proyecto personal que busca una buena experiencia de usuario, compartiendo experiencias y mejoras como programador",
    en:
      "A personal project that seeks a good user experience, sharing experiences and improvements as a programmer",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.NEXT, Topics.TYPESCRIPT, Topics.VERCEL],
  links: [
    {
      href:
        "https://res.cloudinary.com/ds5ayigjw/image/upload/v1619854251/my-website/senixcode-web-screen-aboutme.png",
      name: translater(currentLanguagee, {
        es: "imagen sobre mi",
        en: "image about me",
      }),
    ...
    },
    {
      ...
      name: translater(currentLanguagee, {
        es: "repositorio mi web",
        en: "repository my web",
      }),
...
const myApi = (currentLanguagee: string): IProject => ({
  ...
  summary: translater(currentLanguagee, {
    es:
      "Es un proyecto personal para agregar dinámicamente cada proyecto, pronto autenticación con suscripciones para notificar proyectos nuevos y blogs interesantes sobre la programación",
    en:
      "It is a personal project to dynamically add each project, soon authentication with subscriptions to notify new projects and interesting blogs about programming.",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.NEST, Topics.TYPESCRIPT, Topics.GRAPHQL],
  links: [
    {
      href: "https://github.com/senixcode/api-my-website",
      name: translater(currentLanguagee, {
        es: "repositorio mi api",
        en: "repository my api",
      }),
      icon: IconsFontawesome.GITHUB,
      category: CategoryLink.ICON,
    },
...
const myCms = (currentLanguagee: string): IProject => ({
  ...
  summary: translater(currentLanguagee, {
    es:
      "Es un proyecto personal para ayudarme a gestionar como un dashboar la data de mi api.",
    en:
      "It is a personal project to help me to manage as a dashboar the data of my api.",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.REACT, Topics.GRAPHQL, Topics.BOOTSWATCH],
  links: [
    {
      href: "https://github.com/senixcode/cms-my-website",
      name: translater(currentLanguagee, {
        es: "repositorio mi cms",
        en: "repository my cms",
      }),
      icon: IconsFontawesome.GITHUB,
      category: CategoryLink.ICON,
    },
...
const lightboxCustom = (currentLanguagee: string): IProject => ({
  ...
  summary: translater(currentLanguagee, {
    es:
      "Es un proyecto que requería para mi web, no encontré una librería, decidí realizar el proyecto por aparte que es una galería masonry de imágenes y videos, también muestra un modal con slider de imágenes hecho en react y typescript",
    en:
      'It is a project that I needed for my website, I did not find a library, I decided to make the project separately which is a "masonry" gallery of images and videos, also shows a modal with slider all this done in react with typescript.',
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.REACT, Topics.CSS],
  links: [
    {
      href: "https://github.com/senixcode/senixcode-lightbox-custom",
      name: translater(currentLanguagee, {
        es: "repositorio lightbox",
        en: "repository lightbox",
      }),
      icon: IconsFontawesome.GITHUB,
      category: CategoryLink.ICON,
    },
    {
      href:
        "https://codesandbox.io/s/github/senixcode/gallery-custom-typescript",
...
const cicularBarAnimation = (currentLanguagee: string): IProject => ({
  title: translater(currentLanguagee, {
    es: "Animación barra circular",
    en: "Circular bar animation",
  }),
  titleSeo: translater(currentLanguagee, {
    es: "senixcode_barra_circular_animado",
    en: "senixcode_cicular_bar_animation",
  }),
  summary: translater(currentLanguagee, {
    es:
      "Fue una colaboración de un proyecto bancario en React Native, donde se requería una barra circular animada, según el porcentaje cambiaria de colores, decidí hacerlo nunca antes había hecho algo aparecido.",
    en:
      "It was a collaboration for a banking project in React Native, where an animated circular bar was required, depending on the percentage it would change colors, I decided to do it, I had never done something like that before.",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.REACT_NATIVE, Topics.EXPO],
  links: [
    {
...
const lightweightEcommerceTemplate = (currentLanguagee: string): IProject => ({
  title: translater(currentLanguagee, {
    es: "Template ligero de ecommerce",
    en: "lightweight ecommerce template",
  }),
  titleSeo: "lightweight-ecommerce-template",
  summary: translater(currentLanguagee, {
    es:
      "Es un proyecto de practica, donde use currentLanguage storage para guardar los datos,  material ui para diseñarlo, y geocurrentLanguageización para mostrar el código de País.",
    en:
      "It is a practice project, where I used currentLanguage storage to save the data, ui material to design it, and geolocation to show the country code.",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  links: [
    {
      ...
      name: translater(currentLanguagee, {
        es: "repositorio ecommerce_ligero",
        en: "repository lightweight_ecommerce",
      }),
      icon: IconsFontawesome.GITHUB,
      category: CategoryLink.ICON,
    },
    {
      ...
      name: translater(currentLanguagee, {
        es: "demo ecommerce_ligero",
        en: "demo lightweight_ecommerce",
      }),
      icon: IconsFontawesome.LINK,
      category: CategoryLink.ICON,
    },
    {
      href:
        "https://res.cloudinary.com/ds5ayigjw/image/upload/v1619855491/my-website/senixcode-ecommerce-home.png",
      name: translater(currentLanguagee, {
        es: "ecommerce_ligero_home",
        en: "lightweight_ecommerce_home",
      }),
      category: CategoryLink.IMAGE,
    },
    {
      href:
        "https://res.cloudinary.com/ds5ayigjw/image/upload/v1619855491/my-website/senixcode-ecommerce-product.png",
      name: translater(currentLanguagee, {
        es: "ecommerce_ligero_producto",
        en: "lightweight_ecommerce_product",
      }),
      category: CategoryLink.IMAGE,
    },
    {
      href:
        "https://res.cloudinary.com/ds5ayigjw/image/upload/v1619855491/my-website/senixcode-ecommerce-cart.png",
      name: translater(currentLanguagee, {
        es: "ecommerce_ligero_carrito",
        en: "lightweight_ecommerce_cart",
      }),
      category: CategoryLink.IMAGE,
    },
  ],
...
const deployDigitalOceanDockerTerraform = (
  currentLanguagee: string
): IProject => ({
  title: translater(currentLanguagee, {
    es: "Deploy con docker y terraform",
    en: "Deploy with docker and terraform",
  }),
  titleSeo: "senixcode_deploy_digitalOcean_docker_terraform",
  summary: translater(currentLanguagee, {
    es:
      "Configure droplet, dns, configuración de servidor con terraform, y con un archivo docker-composer configure los certificados ssl redireccionando a un conteiner de nodejs",
    en:
      "Configure droplet, dns, server configuration with terraform, and with a docker-composer file configure the ssl certificates by redirecting to a nodejs container",
  }),
  description: paserDescription(
    translater(currentLanguagee, {
  ...
  topic: [Topics.DOCKER, Topics.TYPESCRIPT, Topics.DIGITAL_OCEAN, Topics.NODE],
  links: [
    {
      href: "https://github.com/senixcode/automatic-ssl-docker-nginx",
      name: translater(currentLanguagee, {
        es: "repositori docker_terraform_automatizacion",
        en: "repository docker_terraform_automation",
      }),
      icon: IconsFontawesome.GITHUB,
      category: CategoryLink.ICON,
    },
